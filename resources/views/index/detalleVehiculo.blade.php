                        ...
                        <div class="row ">
                            @foreach ($marcas->Message as $indexM)
                                @if ($indexM->ID_Marca == $index->Marca)
                                    <div class="col-md-9 titulo_vehiculo" style="text-align: end">{{ $indexM->Marca }}
                                        {{ $index->Linea }}</div>
                                    <div class="col-md-3">
                                        <button type="button" class="btn border-0" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal_{{ $index->ID_Vehiculo }}">
                                            <img style="width: 20%" src="{{ asset('img/reservar.png') }}">
                                        </button>
                                    </div>
                                    <!-- Modal -->
                                    <div class="modal fade" id="exampleModal_{{ $index->ID_Vehiculo }}" tabindex="-1"
                                        aria-labelledby="exampleModalLabel_{{ $index->ID_Vehiculo }}" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header" style="border-bottom: 3px solid black !important">
                                                    <h5 class="modal-title" style="text-align: center !important"
                                                        id="exampleModalLabel_{{ $index->ID_Vehiculo }}">
                                                        <b>RESERVA DE VEHÍCULO</b>
                                                    </h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form method="POST" action="{{ url('api/detallereserva') }}">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="PrecioBase"
                                                                placeholder="Precio base" aria-label="Precio base">
                                                        </div>
                                                        <div class="input-group mb-3">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="Adicionales"
                                                                placeholder="Adicionales" aria-label="Adicionales">
                                                        </div>
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text">Q</span>
                                                            <input type="text" class="form-control"
                                                                name="PrecioFinalCliente" placeholder="Precio Final"
                                                                aria-label="Precio Final">
                                                        </div>
                                                        <div class="input-group mb-3">
                                                            <input type="text" class="form-control" name="PrecioTotal"
                                                                placeholder="Precio Total" aria-label="Precio Total">
                                                        </div>
                                                        <div class="input-group mb-3">
                                                        ...
                                                        <button type="submit" class="btn btn-lg text-light"
                                                            style="background-color: #3C486B; float: right; border-radius: 20px">
                                                            Confirmar reserva
                                                        </button>
                                                    </form>
                                                </div>
